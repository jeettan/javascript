...
function randomBackground() {
    ...
    switch (randomXToY(1, 3)) {
        case 1:
            rand = 1;
            document.getElementsByClassName('background-container')[0].style.backgroundImage = "url('./images/background1.jpg')"
            break;

        case 2:
            rand = 2;
            document.getElementsByClassName('background-container')[0].style.backgroundImage = "url('./images/background2.jpg')"
            break;
        case 3:
            rand = 3;
            document.getElementsByClassName('background-container')[0].style.backgroundImage = "url('./images/background3.jpg')"
            break;
    }
}
